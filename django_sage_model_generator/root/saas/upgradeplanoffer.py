...
class Upgradeplanoffer(models.Model):

    plan = models.ForeignKey(
        "Plan", related_name="plan_UpgradePlanOffer", on_delete=models.CASCADE
    )

    offer = models.ForeignKey(
        "Offer", related_name="offer_UpgradePlanOffer", on_delete=models.CASCADE
    )

    class Meta:
        db_table = "UpgradePlanOffer"
